...
class ToDosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do" do
    assert_difference('ToDo.count') do
      post to_dos_url, params: { to_do: { Comentarios: @to_do.Comentarios, Nota: @to_do.Nota, Titulo: @to_do.Titulo } }
    end
  ...
  test "should update to_do" do
    patch to_do_url(@to_do), params: { to_do: { Comentarios: @to_do.Comentarios, Nota: @to_do.Nota, Titulo: @to_do.Titulo } }
